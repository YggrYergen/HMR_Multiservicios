...
import { ClipboardList, Tag, Shield, Coffee } from 'lucide-react';
...
const steps = [
  {
    ...
    icon: ClipboardList,
    title: 'Planifica',
    description: 'Lista de tareas 2 semanas antes de tu mudanza.',
  },
  {
    number: '02',
    icon: Tag,
    title: 'Etiqueta',
    description: 'Anota contenido y habitación destino en cada caja.',
  },
  {
    number: '03',
    icon: Shield,
    title: 'Cuida',
    description: 'Embala lo frágil con ropa o papel para protegerlo.',
  },
  {
    number: '04',
    icon: Coffee,
    title: 'Relájate',
    description: 'Nosotros hacemos el resto. Disfruta tu nueva casa.',
  },
];
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-accent overflow-hidden">
      <div className="container">
        ...
        >
          <h2 className="text-display text-white">Tu Mudanza en 4 Pasos</h2>
          <p className="mt-4 text-white/60 font-body">
            Sigue estos consejos para una experiencia perfecta
          </p>
        </motion.div>
      </div>
